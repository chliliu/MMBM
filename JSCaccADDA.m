function [accP,k]=JSCaccADDA(AI,BI,CI,DI,n,m,nb,u,v)
p=nb;
N=m+n-p;
A=BI';B=AI';
C=CI';D=DI';
...
opts.tol=1e-80;  %  tolerance for stopping DA iteration
opts.maxitn=100;  % max number of iterations allowed
opts.res=1;
opts.exact=0;
...
[X1, Y1, info1]=accADDA_L(m, n, W, opts);
k=info1.itn;
